...
echo -e "   2. lanciare lo script run_after_exam_texts_in_shuttle.sh per ottenere le cartelle compresse e per predisporre la cartella shuttle in modo che possa essere caricata sul Web Server per gli accessi degli studenti regolati da credenziali." >> passi_da_compiere_dopo_aver_generato_il_file_con_chiavi.md
