...
wget --user <VR??????> --password <vedi sopra> {SHUTTLE_FOLDER_ON_WEB_SERVER}/{rel_path_TGZ_file_for_student}
...
<p><a href="{SHUTTLE_FOLDER_ON_WEB_SERVER}/{rel_path_TGZ_file_for_student}">{SHUTTLE_FOLDER_ON_WEB_SERVER}/{rel_path_TGZ_file_for_student}</a></p>
<p></p>
...
<p></p>
<p>wget --user VR?????? --password quella_specificata_sopra {SHUTTLE_FOLDER_ON_WEB_SERVER}/{rel_path_TGZ_file_for_student}</p>
<p></p>
